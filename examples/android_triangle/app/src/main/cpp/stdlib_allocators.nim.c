...
N_LIB_PRIVATE N_NIMCALL(void*, colonanonymous___iJMelSyRU6RWIBySdiz9a5A)(AllocatorObj* a, NI size, NI alignment) {
	...
	result = (void*)0;
	result = alloc0__1Sx5YIRdVWZ4weqfKjYzWA(((NI)chckRange(size, ((NI) 0), ((NI) 2147483647))));
...
N_LIB_PRIVATE N_NIMCALL(void*, colonanonymous___3oPBf9aBNzv9c0DCHOew9a65Q)(AllocatorObj* a, void* p, NI oldSize, NI newSize) {
	...
	result = (void*)0;
	result = realloc__XYb75pepKTKtzv9abwjURxA(p, ((NI)chckRange(newSize, ((NI) 0), ((NI) 2147483647))));
	TM__swLlbja8p0i4f2bNaYLjXA_4 = subInt(newSize, oldSize);
	nimZeroMem(((void*) ((NI)((NU32)(((NI) (ptrdiff_t) (result))) + (NU32)(oldSize)))), ((NI)chckRange((NI)(TM__swLlbja8p0i4f2bNaYLjXA_4), ((NI) 0), ((NI) 2147483647))));
	return result;
}
