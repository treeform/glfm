...
} TM__zG6mA2D5kuOdfHNU9b6qlqQ_29 = { 11, NIM_NIL, "simple.vert" };
static const NimStringV2 TM__zG6mA2D5kuOdfHNU9b6qlqQ_30 = {11, (NimStrPayload*)&TM__zG6mA2D5kuOdfHNU9b6qlqQ_29};
static const struct {
  NI cap; void* allocator; NIM_CHAR data[11+1];
} TM__zG6mA2D5kuOdfHNU9b6qlqQ_31 = { 11, NIM_NIL, "simple.frag" };
static const NimStringV2 TM__zG6mA2D5kuOdfHNU9b6qlqQ_32 = {11, (NimStrPayload*)&TM__zG6mA2D5kuOdfHNU9b6qlqQ_31};
static NIM_CONST tyProc__l6Br0mXghIMqU7Ht2wXupA TM__zG6mA2D5kuOdfHNU9b6qlqQ_33 = {NIM_NIL,NIM_NIL};
static const struct {
  NI cap; void* allocator; NIM_CHAR data[10+1];
} TM__zG6mA2D5kuOdfHNU9b6qlqQ_35 = { 10, NIM_NIL, "setup done" };
NIM_CONST tyArray__nHXaesL0DJZHyVS07ARPRA TM__zG6mA2D5kuOdfHNU9b6qlqQ_34 = {{10, (NimStrPayload*)&TM__zG6mA2D5kuOdfHNU9b6qlqQ_35}}
;
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, readAssetFile__KxN9a7qmfFyH656Mbrc9cejA)(NimStringV2 filename) {
	...
	T2_ = mnewString(((NI)chckRange(size, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln_(34, "/p/Nim/lib/system/fatal.nim");
	eqsink___aBBXmHFBEivKqERloP6zmA((&result), T2_);
	nimln_(155, "/p/glfm/examples/main.nim");
	T3_ = (int)0;
	T3_ = glfmReadFileBuffer(nimToCStringConv(filename), nimToCStringConv(result));
	(void)(T3_);
	popFrame();
	return result;
}
...
{	_nimCurFrame = getFrame();
	...
	if (TM__zG6mA2D5kuOdfHNU9b6qlqQ_13.status == 0) {
		...
		NI T19_;
		NI TM__zG6mA2D5kuOdfHNU9b6qlqQ_36;
		...
		nimln_(164, "/p/glfm/examples/main.nim");
		{
			...
			T6_ = readAssetFile__KxN9a7qmfFyH656Mbrc9cejA(TM__zG6mA2D5kuOdfHNU9b6qlqQ_30);
			nimln_(34, "/p/Nim/lib/system/fatal.nim");
			...
			nimln_(167, "/p/glfm/examples/main.nim");
			T7_.len = 0; T7_.p = NIM_NIL;
			T7_ = readAssetFile__KxN9a7qmfFyH656Mbrc9cejA(TM__zG6mA2D5kuOdfHNU9b6qlqQ_32);
			nimln_(34, "/p/Nim/lib/system/fatal.nim");
			...
			nimln_(168, "/p/glfm/examples/main.nim");
			{
				...
				glfmSetMainLoopFunc(display, TM__zG6mA2D5kuOdfHNU9b6qlqQ_33);
			...
			echoBinSafe(TM__zG6mA2D5kuOdfHNU9b6qlqQ_34, 1);
		}
		LA4_: ;
		...
		T19_ = vertices.len;
		TM__zG6mA2D5kuOdfHNU9b6qlqQ_36 = mulInt(T19_, ((NI) 4));
		if ((NU)(((NI) 0)) >= (NU)vertices.len) raiseIndexError2(((NI) 0),vertices.len-1);
		glBufferData__VLz8e7mQdBq50nh4P9btjaA(((NU32) 34962), (NI)(TM__zG6mA2D5kuOdfHNU9b6qlqQ_36), ((void*) ((&vertices.p->data[((NI) 0)]))), ((NU32) 35044));
